...
def extract_user_tags(attributes: dict) -> dict:
    """
    Normalize and flatten attributes['usertags'] to columns like:
      department_1, location_1, office_location_1, manager_email_address_1, title_1, ...
    """
    out = {}
...
# ======================================
def main():
    logger.info("Starting Proofpoint → Postgres incremental sync (with debug prints).")
